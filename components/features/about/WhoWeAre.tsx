...
const SECTIONS = [
  ...
  {
    title: "Our Commmuntities",
    content:
      "dSandBox operates through city-based communities led by passionate designers.Our flagship chapter — dSandBox Ogbomoso — is already building a strong culture of collaboration, innovation, and creativity.",
    icon: "/connect.png",
    image: "/vision-image.png",
  },
];
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {SECTIONS.map((item) => {
          return (
            <div
              key={item.title}
              className="relative overflow-hidden text-white rounded-3xl border border-gray-800 bg-black p-6 min-h-[200px]"
            >
              <div className="mb-3 flex items-start gap-3">
                ...
                <button
                  ...
                  aria-expanded={openKey === item.title}
                >
                  {item.title}
                </button>
              </div>
              ...
              <button
                type="button"
                onClick={() => handleOpenModal(item.title)}
                className="absolute right-6 bottom-6 h-20 w-20 rounded-tl-2xl bg-primary-200 text-white shadow-lg transition-transform hover:scale-105 focus:scale-105 flex items-center justify-center"
          ...
          >
            ...
            <div className="relative w-full h-[500px] bg-linear-to-br from-[#FF8C00]/20 to-orange-600/20 flex items-center justify-center">
              ...
              {/* <div className="text-center p-8">
                ...
                <p className="text-gray-300">Large image would appear here</p>
